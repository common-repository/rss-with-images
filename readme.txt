...
For additional features you can also check out the [RSS with Images Pro](http://endif.media/rss-with-images-premium) version.
...
= 1.3.5 =
* Added Support for WP version 4.3.1
